...
class ViewModel: ObservableObject {
    ...
    @Published var imageDesc: String = ""
    ...
    func addMyImage(_ name: String, desc: String, image: UIImage) {
        reset()
        let myImage = MyImage(name: name, desc: desc)
        do {
